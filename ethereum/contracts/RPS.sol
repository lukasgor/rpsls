...
contract RPSFactory {
    ...
    function createGame(bytes32 c1Hash, address opponentAddress) public payable {
        address newGame = (new RPS).value(msg.value)(c1Hash, msg.sender, opponentAddress);
...
contract RPS{
     ...
     */
    function RPS(bytes32 _c1Hash, address _j1, address _j2) payable {
